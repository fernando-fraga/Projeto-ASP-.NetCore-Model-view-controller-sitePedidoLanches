...
namespace LanchesMac.Areas.Admin.Controllers
{
    ...
    public class AdminPedidosController : Controller
    {
        ...
        // GET: Admin/AdminPedidos                                                  //Index padrão comentada para criacao da exibicao com filtro
        ...
        {
            var resultado = _context.Pedidos.AsNoTracking()     //Com o AsnoTracking as entidades não são rastreadas pelo contexto, assim o EF Core não realiza nenhum processamento adicional nas entidades
                .AsQueryable(); //Converte a coleção para o tipo IQueryable
