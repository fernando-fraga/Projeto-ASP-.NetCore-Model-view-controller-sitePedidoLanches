    ...
    public class GraficoVendasService
    {
        ...
        public List<LancheGrafico> GetVendasLanches (int dias = 360) 
        {
            ...
            var lanches = (from pd in context.PedidoDetalhes
                           join l in context.Lanches on pd.LancheId equals l.LancheId  //Nessa linhas fazemos o Join das Tabelas PedidosDetalhes com a tabela Lanches utilizando o parametro LancheId como critério
